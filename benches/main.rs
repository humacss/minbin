...
const STR_100B_1B_CHARS: &str =
    "SYS:2025-12-11T11:11:11.123Z|temp=23.4C|hum=56%|load=1.23|uptime=123456s";
...
fn all_benches(runner: &mut Criterion) {
    ...
    bench_value(
        runner,
        "String_100b_1b_chars",
        STR_100B_1B_CHARS.to_string(),
    );
    bench_value(
        runner,
        "String_100b_4b_chars",
        STR_100B_4B_CHARS.to_string(),
    );
